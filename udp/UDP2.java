...
class UDP2
{
	...
	public static int cport = 333,sport=555;
...
Random rand = new Random();
    ...
    data[0]=(byte)(n);data[1]=9;data[2]=0;data[3]=2;
         while(true)
         {
  ...
  if(((int)buf[0])==0)
{
  ...
  buf[1]=(byte)a;
   ...
   buf = str6.getBytes();
   serversocket.send(new DatagramPacket(buf,str6.length(),ia,222));
}
